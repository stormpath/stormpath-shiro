 ...
 * <p/>
 * An OverridableIni instance is a map of {@link com.stormpath.shiro.servlet.conf.OverridableIni.Section Section}s, keyed by section name.  Each
...
public class OverridableIni implements Map<String, OverridableIni.Section> {
    ...
    /**
     * Returns the {@link com.stormpath.shiro.servlet.conf.OverridableIni.Section} with the given name or {@code null} if no section with that name exists.
     *
     * @param sectionName the name of the section to retrieve.
     * @return the {@link com.stormpath.shiro.servlet.conf.OverridableIni.Section} with the given name or {@code null} if no section with that name exists.
     */
     ...
     * {@link org.apache.shiro.io.ResourceUtils#getInputStreamForPath(String) ResourceUtils.getInputStreamForPath} method.
     *
     ...
     * @throws org.apache.shiro.config.ConfigurationException if the path cannot be loaded into an {@code OverridableIni} instance.
     */
     ...
     * @throws org.apache.shiro.config.ConfigurationException if the path cannot be loaded
     */
     ...
     * @throws org.apache.shiro.config.ConfigurationException if the text cannot be loaded
     */
     ...
     * @throws org.apache.shiro.config.ConfigurationException if unable
     */
     ...
     * {@link #getName() name} unique within an {@link com.stormpath.shiro.servlet.conf.OverridableIni} instance.
     */
