...
/**
 * A {@link RequestEventListener} that simply re-publishes all events to a Shiro {@link EventBus}.
 * @since 0.7
 */
public class RequestEventListenerBridge implements RequestEventListener, EventBusAware {
