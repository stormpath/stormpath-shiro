...
@ContextConfiguration(classes = [ShiroAnnotationProcessorConfiguration, RealmConfiguration, ShiroConfiguration])
public class ShiroConfigurationTest extends AbstractTestNGSpringContextTests {
