...
class ProviderServiceTest {
    ...
    public void testCreateProviderAccountStore() {
        ...
        expect(directory.setName(contains(appName + "-SOMEPROVIDERID"))).andReturn(directory)
        ...
        expect(asm.setAccountStore(directory)).andReturn(asm)
        expect(asm.setApplication(app)).andReturn(asm)
        expect(asm.setListIndex(Integer.MAX_VALUE)).andReturn(asm)
        expect(asm.setDefaultAccountStore(false)).andReturn(asm)
        expect(asm.setDefaultGroupStore(false)).andReturn(asm)
